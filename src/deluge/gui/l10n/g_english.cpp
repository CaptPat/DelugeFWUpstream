...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_PATCH_SOURCE_LFO_GLOBAL_2, "LFO3"},
        {STRING_FOR_PATCH_SOURCE_LFO_LOCAL_1, "LFO2"},
        {STRING_FOR_PATCH_SOURCE_LFO_LOCAL_2, "LFO4"},
        ...
        {STRING_FOR_PARAM_GLOBAL_LFO_FREQ_1, "LFO1 rate"},
        {STRING_FOR_PARAM_LOCAL_LFO_LOCAL_FREQ_1, "LFO2 rate"},
        {STRING_FOR_PARAM_GLOBAL_LFO_FREQ_2, "LFO3 rate"},
        {STRING_FOR_PARAM_LOCAL_LFO_LOCAL_FREQ_2, "LFO4 rate"},
        ...
        {STRING_FOR_BASS_FREQUENCY_SHORT, "Bfrq"},
        {STRING_FOR_TREBLE, "TREBLE"},
        {STRING_FOR_TREBLE_FREQUENCY, "Treble frequency"},
        {STRING_FOR_TREBLE_FREQUENCY_SHORT, "Tfrq"},
        ...
        {STRING_FOR_BALANCED_INPUT, "Balanced input"},
        {STRING_FOR_MIX_PRE_FX, "Deluge mix (no fx)"},
        {STRING_FOR_MIX_POST_FX, "Deluge output (fx)"},
        ...
        {STRING_FOR_MINOR, "MIN"},
        {STRING_FOR_MAJOR, "MAJ"},
        {STRING_FOR_SUS4, "SUS4"},
        {STRING_FOR_MINOR7, "MIN7"},
        {STRING_FOR_DOMINANT7, "DOM7"},
        {STRING_FOR_MAJOR7, "MAJ7"},
        ...
        {STRING_FOR_MODULATOR_SHORT, "Mod"},
        ...
        {STRING_FOR_PATTERN_NOSCALING, "No scaling.."},
        {STRING_FOR_PATTERN_NOOVERWRITE, "No overwrite.."},
        {STRING_FOR_PATTERN_NODRUM, "No Drum Selected.."},
        {STRING_FOR_PATTERN_PREVIEW, "Preview.."},
        ...
        {STRING_FOR_INSTRUMENTS_WITH_CLIPS_CANT_BE_TURNED_INTO_AUDIO_TRACKS, "Instruments with clips can't be turned into audio tracks"},
        ...
        {STRING_FOR_AUDIO_TRACKS_WITH_CLIPS_CANT_BE_TURNED_INTO_AN_INSTRUMENT, "Audio tracks with clips can't be turned into an instrument"},
        ...
        {STRING_FOR_USE_SONG_SHORT, "USE SONG"},
        ...
        {STRING_FOR_ACTIVE_SCALES, "Active scales"},
        {STRING_FOR_USER_SCALE, "User scale"},
        ...
        {STRING_FOR_OSCILLATOR_SHORT, "Osc"},
        {STRING_FOR_OSCILLATOR_SYNC, "Oscillator sync"},
        {STRING_FOR_OSCILLATOR_1, "Oscillator 1"},
        {STRING_FOR_OSCILLATOR_2, "Oscillator 2"},
        {STRING_FOR_OSCILLATOR_MIXER, "Osc mixer"},
        {STRING_FOR_UNISON_NUMBER, "Number"},
        {STRING_FOR_UNISON_NUMBER_SHORT, "Num"},
        {STRING_FOR_UNISON_DETUNE, "Detune"},
        {STRING_FOR_UNISON_STEREO_SPREAD, "Spread"},
        {STRING_FOR_NUMBER_OF_OCTAVES, "Octaves"},
        {STRING_FOR_STEP_REPEAT, "Step Repeat"},
        {STRING_FOR_RHYTHM, "Rhythm"},
        {STRING_FOR_NOTE_PROBABILITY, "Note Probability"},
        {STRING_FOR_OCTAVE_MODE, "Octave Mode"},
        {STRING_FOR_CHORD_SIMULATOR, "Chord Simulator"},
        {STRING_FOR_NOTE_MODE, "Note Mode"},
        {STRING_FOR_NUMBER_OF_RATCHETS, "Ratchet Amount"},
        {STRING_FOR_BASS_PROBABILITY, "Bass Probability"},
        {STRING_FOR_SWAP_PROBABILITY, "Swap Probability"},
        {STRING_FOR_GLIDE_PROBABILITY, "Glide Probability"},
        {STRING_FOR_CHORD_POLYPHONY, "Chord Polyphony"},
        ...
        {STRING_FOR_DEFAULT_UI_DEFAULT_STARTUP_SONG_MODE_BLANK, "New song"},
        ...
        {STRING_FOR_FM_MODULATOR_1, "FM mod 1"},
        ...
        {STRING_FOR_COLUMN_VELOCITY, "Velocity"},
        {STRING_FOR_COLUMN_MOD, "Modwheel"},
        {STRING_FOR_COLUMN_CHORD, "Chords"},
        {STRING_FOR_COLUMN_SONG_CHORD_MEM, "Song Chord Memory"},
        {STRING_FOR_COLUMN_CHORD_MEM, "Clip Chord Memory"},
        {STRING_FOR_COLUMN_SCALE_MODE, "Scales"},
        {STRING_FOR_COLUMN_DX, "DX operators"},
        {STRING_FOR_COLUMN_SESSION, "song macros"},
        {STRING_FOR_COLUMN_BEAT_REPEAT, "Beat Repeat"},
        {STRING_FOR_KEYBOARD_LAYOUT_CHORD_KEYBOARD, "Chord"},
        {STRING_FOR_KEYBOARD_LAYOUT_CHORD_LIBRARY, "Chord Library"},
        {STRING_FOR_KEYBOARD_LAYOUT_IN_KEY, "In-Key"},
        {STRING_FOR_KEYBOARD_LAYOUT_ISOMORPHIC, "Isomorphic"},
        {STRING_FOR_KEYBOARD_LAYOUT_NORNS, "Norns"},
        {STRING_FOR_KEYBOARD_LAYOUT_PIANO, "Piano"},
        {STRING_FOR_KEYBOARD_LAYOUT_VELOCITY_DRUMS, "Velocity Drums"},
        {STRING_FOR_DX_ERROR_FILE_TOO_SMALL, "error: file too small"},
        {STRING_FOR_DX_ERROR_NO_SYSEX_START, "error: no sysex start"},
        {STRING_FOR_DX_ERROR_NO_SYSEX_END, "error: no sysex end"},
        {STRING_FOR_DX_ERROR_INVALID_LEN, "error: invalid length"},
        {STRING_FOR_DX_ERROR_CHECKSUM_FAIL, "error: sysex checksum fail"},
        {STRING_FOR_DX_ERROR_SYSEX_ID, "error: unknown sysex id"},
        {STRING_FOR_DX_ERROR_READ_ERROR, "error: couldn't read file"},
        ...
        {STRING_FOR_DEFAULT_AUTOMATION, "Automation"},
        {STRING_FOR_DEFAULT_AUTOMATION_INTERPOLATION, "Interpolation"},
        {STRING_FOR_DEFAULT_AUTOMATION_CLEAR, "Clear"},
        {STRING_FOR_DEFAULT_AUTOMATION_NUDGE_NOTE, "Nudge Note"},
        {STRING_FOR_DEFAULT_AUTOMATION_SHIFT, "Shift"},
        {STRING_FOR_DEFAULT_AUTOMATION_DISABLE_AUDITION_PAD_SHORTCUTS, "Disable Audition Pad Shortcuts"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_GRAIN_FX, "Grain FX"},
        {STRING_FOR_COMMUNITY_FEATURE_STICKY_SHIFT, "Sticky Shift"},
        {STRING_FOR_COMMUNITY_FEATURE_LIGHT_SHIFT, "Light Shift"},
        {STRING_FOR_COMMUNITY_FEATURE_EMULATED_DISPLAY, "Emulated Display"},
        {STRING_FOR_COMMUNITY_FEATURE_DX7_ENGINE, "DX7 Engine"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_CHORD_KEYBOARD, "Chord Keyboards"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_SUPER_FINE_TEMPO, "Super Fine Tempo"},
        ...
        {STRING_FOR_NOTE_RANDOMIZER, "NOTE RANDOMIZER"},
        {STRING_FOR_PATTERN, "PATTERN"},
        {STRING_FOR_POLYPHONY, "POLYPHONY"},
        {STRING_FOR_POLYPHONY_SHORT, "MODE"},
        {STRING_FOR_MAX_VOICES, "MAX VOICES"},
        {STRING_FOR_MAX_VOICES_SHORT, "VCNT"},
        ...
        {STRING_FOR_RETRIGGER_PHASE_SHORT, "PHSE"},
        {STRING_FOR_LFO1, "LFO 1"},
        {STRING_FOR_LFO2, "LFO 2"},
        {STRING_FOR_LFO3, "LFO 3"},
        {STRING_FOR_LFO4, "LFO 4"},
        {STRING_FOR_LFO_TYPE, "LFO* shape"},
        {STRING_FOR_LFO_SYNC, "LFO* sync"},
        {STRING_FOR_LFO1_RATE, "LFO1 rate"},
        {STRING_FOR_LFO2_RATE, "LFO2 rate"},
        {STRING_FOR_LFO3_RATE, "LFO3 rate"},
        {STRING_FOR_LFO4_RATE, "LFO4 rate"},
        {STRING_FOR_ENVELOPE_MENU_TITLE, "Envelope *"},
        ...
        {STRING_FOR_RELEASE_SHORT, "REL"},
        {STRING_FOR_DAMPING, "DAMPING"},
        {STRING_FOR_WIDTH, "WIDTH"},
        {STRING_FOR_WIDTH_SHORT, "Wdth"},
        {STRING_FOR_REVERB_WIDTH, "Reverb width"},
        {STRING_FOR_REVERB_PAN, "Reverb pan"},
        {STRING_FOR_SATURATION, "SATURATION"},
        {STRING_FOR_MIDI_DEVICE_DEFINITION, "Device Definition"},
        {STRING_FOR_MIDI_DEVICE_DEFINITION_LINKED, "File Linked"},
        ...
        {STRING_FOR_DEPTH_SHORT, "DPTH"},
        {STRING_FOR_MOD_FX_DEPTH, "MOD FX depth"},
        {STRING_FOR_GRAIN_DENSITY, "Grain Density"},
        {STRING_FOR_GRAIN_DENSITY_SHORT, "Density"},
        {STRING_FOR_GRAIN_RANDOMNESS, "Pitch Spread"},
        {STRING_FOR_GRAIN_RANDOMNESS_SHORT, "Spread"},
        {STRING_FOR_GRAIN_AMOUNT, "Grain Mix"},
        {STRING_FOR_GRAIN_AMOUNT_SHORT, "Mix"},
        ...
        {STRING_FOR_COUNT_IN, "Count-in bars"},
        {STRING_FOR_REC_COUNT_IN, "Rec count-in bars"},
        ...
        {STRING_FOR_INIT_SCALE, "Init scale"},
        ...
        {STRING_FOR_RENAME_CLIP, "Rename clip"},
        ...
        {STRING_FOR_ARP_WALK_TITLE, "Arp walk"},
        ...
        {STRING_FOR_ARP_STEP_REPEAT_MENU_TITLE, "Arp step repeat"},
        {STRING_FOR_ARP_RHYTHM_MENU_TITLE, "Arp rhythm"},
        {STRING_FOR_ARP_OCTAVE_MODE_MENU_TITLE, "Arp octave mode"},
        {STRING_FOR_ARP_CHORD_SIMULATOR_MENU_TITLE, "Arp chord sim"},
        {STRING_FOR_ARP_NOTE_MODE_MENU_TITLE, "Arp note mode"},
        {STRING_FOR_ARP_RATCHETS_MENU_TITLE, "Arp ratc amount"},
        {STRING_FOR_NOTE_PROBABILITY_MENU_TITLE, "Note prob"},
        {STRING_FOR_ARP_BASS_PROBABILITY_MENU_TITLE, "Arp bass prob"},
        {STRING_FOR_ARP_SWAP_PROBABILITY_MENU_TITLE, "Arp swap prob"},
        {STRING_FOR_ARP_GLIDE_PROBABILITY_MENU_TITLE, "Arp glide prob"},
        {STRING_FOR_ARP_CHORD_POLYPHONY_MENU_TITLE, "Arp chord poly"},
        {STRING_FOR_ARP_CHORD_PROBABILITY_MENU_TITLE, "Arp chord prob"},
        {STRING_FOR_ARP_RATCHET_PROBABILITY_MENU_TITLE, "Arp ratc prob"},
        {STRING_FOR_REVERSE_PROBABILITY_MENU_TITLE, "Reverse prob"},
        ...
        {STRING_FOR_FULL_INVERSION, "Full inversion"},
        {STRING_FOR_PARTIAL_INVERSION, "Partial inversion"},
        {STRING_FOR_NO_INVERSION, "No inversion"},
        ...
        {STRING_FOR_FORWARD_PING_PONG, "FORW-PING"},
        {STRING_FOR_REVERSED_PING_PONG, "RVRS-PING"},
        ...
        {STRING_FOR_PERFORM_VIEW, "Performance"},
        ...
        {STRING_FOR_TRANSPOSE_PIANO, "Piano"},
        ...
        {STRING_FOR_KEYBOARD_VIEW_CANT_ENTER_SCALE, "Can't enter scale mode in this keyboard view"},
        ...
        {STRING_FOR_NOTE_ROW_EDITOR_PROBABILITY, "Probability"},
        {STRING_FOR_NOTE_ROW_EDITOR_ITERANCE, "Iterance"},
        {STRING_FOR_NOTE_ROW_EDITOR_FILL, "Fill"},
        {STRING_FOR_ITERANCE_DIVISOR, "Divisor"},
        {STRING_FOR_ITERATION_STEP_1, "Iteration 1"},
        {STRING_FOR_ITERATION_STEP_2, "Iteration 2"},
        {STRING_FOR_ITERATION_STEP_3, "Iteration 3"},
        {STRING_FOR_ITERATION_STEP_4, "Iteration 4"},
        {STRING_FOR_ITERATION_STEP_5, "Iteration 5"},
        {STRING_FOR_ITERATION_STEP_6, "Iteration 6"},
        {STRING_FOR_ITERATION_STEP_7, "Iteration 7"},
        {STRING_FOR_ITERATION_STEP_8, "Iteration 8"},
